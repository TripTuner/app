        ...
        .container {
            ...
            .info {
                ...
                .images-container {
                    ...
                    .back-image {
                        transform: translateX(calc(-50% + 15px)) translateY(calc(6px)) rotate(30deg);
                        z-index:   1;
                    ...
                    &:hover {
                        .image {
                            transform: translateX(calc(-50% - 15px)) translateY(0%) rotate(-10deg) scale(1.1);
                        }

                        .back-image {
                            transform: translateX(calc(-50% + 20px)) translateY(calc(0px)) rotate(40deg) scale(1.1);
                        }
                    }
                }
            }
...
export class MapPointInformationComponent {
    ...
    /** @function
     * @description function that handler folder Math move events */
    foldMarkDragHandler(event: TouchEvent) {
        // getting start positions and setting main variables
        let lastY: number = event.touches[0].clientY, currentHeight = this.container.nativeElement.getBoundingClientRect().height;
