                ...
                .content {
                    ...
                    label {
                        ...
                        input {
                            ...
                            border:           none;
                            outline:          none;
                            padding-left:     calc(21px + 16px + 10px);
                ...
                <div class="content">
                    <label>
                        <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.66666 14.5C11.1645 14.5 14 11.6645 14 8.16671C14 4.6689 11.1645 1.83337 7.66666 1.83337C4.16886 1.83337 1.33333 4.6689 1.33333 8.16671C1.33333 11.6645 4.16886 14.5 7.66666 14.5Z"
                                  stroke="#0F62FE" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M14.6667 15.1667L13.3333 13.8334" stroke="#0F62FE" stroke-width="1.5"
                                  stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                        <input placeholder="Начните вводить описание маршрута...">
                    </label>
...
export class BottomBarComponent implements AfterViewInit {
    ...
    hideMainContainer() {
        ...
        setTimeout(() => {
            this.stickPositionButton.nativeElement.style.bottom = '173px';
    ...
    showMainContainer() {
        ...
        this.stickPositionButton.nativeElement.style.transition = 'opacity .3s, background-color .3s, bottom .3s';
        setTimeout(() => {
            this.stickPositionButton.nativeElement.style.bottom = '231px';
