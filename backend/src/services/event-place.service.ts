 ...
 * @returns {Promise<Array<Category>>} a promise with the fetched events
 */
 ...
 * @returns {Promise<Category>} found event, otherwise throws error
 */
 ...
 * @returns {Promise<Category>} saved event if everything ok, otherwise throws error
 */
